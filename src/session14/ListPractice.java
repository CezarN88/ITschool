...
public class ListPractice {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> updatedList = getUpdateList(myList, 1, 10);
    ...
    private static int findMaximum(List<Integer> list) {
    ...
    private static List<Integer> getUpdateList(List<Integer> list, int index, int value) {
